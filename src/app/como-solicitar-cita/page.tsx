            ...
            <div className="container mx-auto max-w-5xl px-4 -mt-8">
                ...
                <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-12">
                    ...
                    <p className="text-gray-700 text-lg leading-relaxed mt-4">
                        Aquí te detallamos cómo funciona este flujo, específicamente desde un establecimiento de primer nivel (posta médica, etc) hacia un hospital referencial de Segundo o Tercer Nivel como nosotros.
                    </p>
                </div>
